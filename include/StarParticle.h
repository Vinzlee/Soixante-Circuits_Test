...
* @class StarParticle
* 
* @brief The StarParticle class provides a star particle from a png File.
* The Star size will shrink with time, and its color is changing with time and position.
*
* @see
*/
...
public:
	...
	*/
	StarParticle(ParticleEngine* pEngine);
